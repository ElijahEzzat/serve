...
class ScheduledRequestDetails extends StatefulWidget{
  @override
  State<ScheduledRequestDetails> createState() => _ScheduledRequestDetailsState();
}

class _ScheduledRequestDetailsState extends State<ScheduledRequestDetails> {
