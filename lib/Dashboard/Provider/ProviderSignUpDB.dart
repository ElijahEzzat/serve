...
import 'package:serve_me/Dashboard/Provider/ProviderCreateProfile.dart';

class ProviderSignupPageDB extends StatefulWidget {
  const ProviderSignupPageDB({super.key});


  @override
  State<ProviderSignupPageDB> createState() => _ProviderSignupPageDBState();
}

class _ProviderSignupPageDBState extends State<ProviderSignupPageDB> {
              ...
              ElevatedButton(
                ...
                onPressed: checkToSubmit() ?
                    (){
                        ...
                        MaterialPageRoute(builder: (context) => ProviderCreateProfileDB()));
                  }
                } : null,
